#ifndef TRACK_INTERSECT_HUD_H_
#define TRACK_INTERSECT_HUD_H_
...
void drawScaledTexture(void* texture, f32 x, f32 y, int alpha, int scale, int width, int height,
                       int flags);
void drawPartialTexture(void* texture, f32 x, f32 y, int alpha, int scale, int width, int height,
                        int u, int v);
