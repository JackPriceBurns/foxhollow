#ifndef MAIN_OBJPRINT_CHARACTER_H_
#define MAIN_OBJPRINT_CHARACTER_H_
...
void characterAimHeadAtTarget(GameObject* obj, GameObject* target, void* state, int limit, u8 inverted, int mode);

#endif /* MAIN_OBJPRINT_CHARACTER_H_ */
