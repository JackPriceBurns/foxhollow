...
int collectShadowTrackTriangles(GameObject* obj, uintptr_t triBuf, void* planesOut, uintptr_t vertsOut,
                                int unusedTriangleCount, f32 offX, f32 offZ, int unusedRenderMode, int kindSelector);
