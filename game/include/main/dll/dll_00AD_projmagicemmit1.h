...
STATIC_ASSERT(offsetof(Projmagicemmit1ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Projmagicemmit1ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Projmagicemmit1ResourceDescriptor, header.release) == 0x14);
