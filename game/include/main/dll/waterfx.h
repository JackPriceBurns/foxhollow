...
extern u8* gWaterfxDropPool;
extern int gWaterfxDropCount;
extern u8* gWaterfxWakePool;
extern int gWaterfxWakeCount;
extern u8* gWaterfxSplashPool;
extern int gWaterfxSplashCount;
extern u8* gWaterfxRipplePool;
...
void waterfx_spawnImpactSurface(u8* p3, u16 mask, f32* vecs, f32 waterDepth, f32 fval);
