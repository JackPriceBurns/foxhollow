...
STATIC_ASSERT(offsetof(Dll8CResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll8CResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll8CResourceDescriptor, header.release) == 0x14);
