...
STATIC_ASSERT(offsetof(Projlightning1ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Projlightning1ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Projlightning1ResourceDescriptor, header.release) == 0x14);
