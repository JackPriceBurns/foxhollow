...
STATIC_ASSERT(offsetof(DllA6ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(DllA6ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(DllA6ResourceDescriptor, header.release) == 0x14);
