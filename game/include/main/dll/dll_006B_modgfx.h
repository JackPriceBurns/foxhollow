...
STATIC_ASSERT(offsetof(Dll6BResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll6BResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll6BResourceDescriptor, header.release) == 0x14);
