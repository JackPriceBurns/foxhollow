...
STATIC_ASSERT(offsetof(Dll9EResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll9EResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll9EResourceDescriptor, header.release) == 0x14);
