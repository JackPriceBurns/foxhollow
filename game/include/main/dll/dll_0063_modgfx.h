...
STATIC_ASSERT(offsetof(Dll63ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll63ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll63ResourceDescriptor, header.release) == 0x14);
