...
STATIC_ASSERT(offsetof(Dll80ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll80ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll80ResourceDescriptor, header.release) == 0x14);
