...
STATIC_ASSERT(offsetof(Projenergise2ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Projenergise2ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Projenergise2ResourceDescriptor, header.release) == 0x14);
