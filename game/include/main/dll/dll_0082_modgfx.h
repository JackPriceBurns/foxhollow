...
STATIC_ASSERT(offsetof(Dll82ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll82ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll82ResourceDescriptor, header.release) == 0x14);
