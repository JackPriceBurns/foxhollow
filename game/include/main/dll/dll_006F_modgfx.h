...
STATIC_ASSERT(offsetof(Dll6FResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll6FResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll6FResourceDescriptor, header.release) == 0x14);
