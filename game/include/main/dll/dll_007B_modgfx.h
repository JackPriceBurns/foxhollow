...
STATIC_ASSERT(offsetof(Dll7BResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll7BResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll7BResourceDescriptor, header.release) == 0x14);
