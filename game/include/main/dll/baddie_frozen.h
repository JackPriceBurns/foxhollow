...
void guardClawUpdateWhileFrozen(GameObject* obj, u8* state, GameObject* attacker, int hit, int p5, int p6, Vec* hitPos,
                                int sector);
void gcRobotPatrol_updateWhileFrozen(GameObject* obj, u8* state, GameObject* attacker, int hit, int p5, int p6,
...
void weevil_updateWhileFrozen(GameObject* obj, u8* state, GameObject* attacker, int hit, int p5, int p6, Vec* hitPos,
                              int sector);
void pinPon_updateWhileFrozen(GameObject* obj, EnemyState* state, GameObject* attacker, int hit, int p5, int p6,
                              Vec* hitPos, int sector);
void wbUpdateWhileFrozen(GameObject* obj, u8* state, GameObject* attacker, int hit, int p5, int p6, Vec* hitPos,
                         int sector);
...
void hagabonMK2_updateWhileFrozen(GameObject* obj, u8* state, GameObject* attacker, int hit, int p5, int p6,
                                  Vec* hitPos, int sector);

void rachnopUpdateWhileFrozen(GameObject* obj, u8* state, GameObject* attacker, int hit, int p5, int p6, Vec* hitPos,
                              int sector);
void spittingEbaUpdateWhileFrozen(GameObject* obj, u8* state, GameObject* attacker, int hit, int p5, int p6,
                                  Vec* hitPos, int sector);
