...
STATIC_ASSERT(offsetof(Dll66ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll66ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll66ResourceDescriptor, header.release) == 0x14);
