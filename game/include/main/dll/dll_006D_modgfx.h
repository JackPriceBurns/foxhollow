...
STATIC_ASSERT(offsetof(Dll6DResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll6DResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll6DResourceDescriptor, header.release) == 0x14);
