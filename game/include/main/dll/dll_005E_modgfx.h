...
STATIC_ASSERT(offsetof(Dll5EResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll5EResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll5EResourceDescriptor, header.release) == 0x14);
