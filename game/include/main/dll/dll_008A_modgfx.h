...
STATIC_ASSERT(offsetof(Dll8AResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll8AResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll8AResourceDescriptor, header.release) == 0x14);
