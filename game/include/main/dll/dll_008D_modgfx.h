...
STATIC_ASSERT(offsetof(Dll8DResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll8DResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll8DResourceDescriptor, header.release) == 0x14);
