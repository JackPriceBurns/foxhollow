...
STATIC_ASSERT(offsetof(CameraMode54Descriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(CameraMode54Descriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(CameraMode54Descriptor, header.release) == 0x14);
