...
STATIC_ASSERT(offsetof(Dll7AResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll7AResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll7AResourceDescriptor, header.release) == 0x14);
