...
STATIC_ASSERT(offsetof(Dll71ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll71ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll71ResourceDescriptor, header.release) == 0x14);
