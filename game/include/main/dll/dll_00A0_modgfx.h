...
STATIC_ASSERT(offsetof(DllA0ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(DllA0ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(DllA0ResourceDescriptor, header.release) == 0x14);
