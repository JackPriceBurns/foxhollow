...
STATIC_ASSERT(offsetof(Dll73ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll73ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll73ResourceDescriptor, header.release) == 0x14);
