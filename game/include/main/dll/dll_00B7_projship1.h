...
STATIC_ASSERT(offsetof(Projship1ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Projship1ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Projship1ResourceDescriptor, header.release) == 0x14);
