...
STATIC_ASSERT(offsetof(Dll9DResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll9DResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll9DResourceDescriptor, header.release) == 0x14);
