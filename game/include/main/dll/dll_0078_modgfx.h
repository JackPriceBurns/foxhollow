...
STATIC_ASSERT(offsetof(Dll78ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll78ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll78ResourceDescriptor, header.release) == 0x14);
