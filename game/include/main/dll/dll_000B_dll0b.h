...
s16 dll_0B_spawnEffect(ModgfxSpawnContext* context, int unused, int vertexCount, const void* vertexData, int colorCount,
                       const void* colorData, int textureAssetId, void* textureResource);
