...
typedef struct BaddieControlInterface {
    ...
    void (*updateMovementBlend)(GameObject* obj, void* state, void* unusedState, f32 maxSpeed,
                                f32 turnSpeed); /* 0x10 */
    void (*getTargetGeometry)(GameObject* obj, GameObject* target, int divisions, u16* sectorOut, u16* yawDeltaOut,
                              u16* distanceOut);                             /* 0x14 */
    u8 (*getClearDirectionMask)(GameObject* obj, void* state, f32 distance); /* 0x18 */
    void (*pad1C_slots[3])(void);
    void (*startHitReaction)(GameObject* obj, void* state, void* hitbox, s16 gameBit, u8* flagOut, s16 substate,
                             s16 moveMode, int animMove, s8 physicsActive);             /* 0x28 */
    ...
    void (*pollCameraTarget)(GameObject* obj, void* state, u16* flags, int modeA, int modeB, s16 soundIdA,
                             s16 soundIdB);                                                       /* 0x3C */
    ...
    int (*updateHitReaction)(GameObject* obj, void* state, void* hitbox, s16 gameBit, int* moveTable, u8* damageTable,
                             s16 substate, void* hitPosOut); /* 0x50 */
    int (*processMessages)(GameObject* obj, void* state, void* hitbox, s16 gameBit, u8* flagOut, s16 substateIdle,
                           s16 substateActive, s16 moveMode); /* 0x54 */
    void (*initGroundBaddie)(GameObject* obj, u8* config, u8* state, int moveArg0, int moveArg1, int pathFlags,
                             u8 initFlags, f32 pathRadius); /* 0x58 */
