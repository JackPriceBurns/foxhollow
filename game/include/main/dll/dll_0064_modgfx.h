...
STATIC_ASSERT(offsetof(Dll64ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll64ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll64ResourceDescriptor, header.release) == 0x14);
