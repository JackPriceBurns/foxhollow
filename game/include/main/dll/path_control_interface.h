...
typedef void (*PathControlSetLocalPointCollisionFn)(void* pathState, int pointCount, void* localPointPositions,
                                                    void* localPointRadii, int primaryHitType);
typedef void (*PathControlSetupFn)(void* pathState, int segmentCount, void* segmentLocalPoints, void* segmentRadii,
                                   void* segmentSourceTypes);
