...
STATIC_ASSERT(offsetof(Dll5CResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll5CResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll5CResourceDescriptor, header.release) == 0x14);
