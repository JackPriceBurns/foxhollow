...
typedef void (*WaterfxImpactSurfaceFn)(u8* objHeader, u16 limbMask, f32* impactPositions, f32 waterDepth, f32 speed);
typedef void (*WaterfxRenderFn)(int renderPass, int flags);
typedef void (*WaterfxSpawnSplashBurstFn)(void* sourceObject, f32 x, f32 y, f32 z, f32 radius);
typedef void (*WaterfxSpawnRippleFn)(f32 x, f32 y, f32 z, s16 sourceId, f32 radius, int intensity);
typedef void (*WaterfxSpawnSimpleRippleFn)(f32 x, f32 y, f32 z, s16 sourceId, f32 radius);
