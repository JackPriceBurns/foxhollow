...
STATIC_ASSERT(offsetof(DummyA4ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(DummyA4ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(DummyA4ResourceDescriptor, header.release) == 0x14);
