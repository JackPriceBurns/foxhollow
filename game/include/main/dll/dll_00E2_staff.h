...
typedef struct StaffInterface
{
    ...
    s16 (*getHitReactValue)(GameObject* staff);
...
OBJECT_DESCRIPTOR_TYPE(StaffDescriptor, StaffInterface);

extern StaffDescriptor gStaffObjDescriptor;
...
#endif /* MAIN_DLL_DLL_00E2_STAFF_H_ */
