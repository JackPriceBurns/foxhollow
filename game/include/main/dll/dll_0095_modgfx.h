...
STATIC_ASSERT(offsetof(Dll95ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Dll95ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Dll95ResourceDescriptor, header.release) == 0x14);
