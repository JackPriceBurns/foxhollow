...
STATIC_ASSERT(offsetof(ProjrobotfireResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(ProjrobotfireResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(ProjrobotfireResourceDescriptor, header.release) == 0x14);
