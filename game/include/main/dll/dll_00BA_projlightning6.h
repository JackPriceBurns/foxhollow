...
STATIC_ASSERT(offsetof(Projlightning6ResourceDescriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(Projlightning6ResourceDescriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(Projlightning6ResourceDescriptor, header.release) == 0x14);
