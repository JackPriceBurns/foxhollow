...
STATIC_ASSERT(offsetof(CameraMode55Descriptor, header.metadata) == 0x00);
STATIC_ASSERT(offsetof(CameraMode55Descriptor, header.acquire) == 0x10);
STATIC_ASSERT(offsetof(CameraMode55Descriptor, header.release) == 0x14);
