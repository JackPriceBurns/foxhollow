...
typedef void (*CameraSetModeFn)(int mode, int arg1, int arg2, int flags, void* params, int blendFrames, u8 queueMode);
...
typedef void (*CameraInitialiseFn)(f32 numerator, f32* dst, f32 denominator, f32 minValue, f32 y, f32 z);
typedef void (*CameraGetRelativePositionFn)(void* targetObj, f32* outX, f32* outY, f32* outZ, f32* outDistanceXZ,
