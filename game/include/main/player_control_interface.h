...
typedef struct PlayerControlInterface {
    ...
    void (*update)(void* obj, void* state, f32 timeDelta, f32 pathDelta, void* stateHandlers, void* substateHandlers);
    ...
    void (*moveTowardPoint)(void* obj, void* state, f32 x, f32 z, f32 minDistance, f32 maxDistance, f32 speed);
    ...
    void (*rotateTowardTarget)(void* obj, void* state, f32 timeDelta, int speed);
