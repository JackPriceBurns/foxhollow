...
enum GameBitId {
    ...
    GAMEBIT_CF_UncleFlewOff =
        0x50, /* Set once the old CloudRunner prisoner (cfprisonuncle) has flown off after his cage is opened; gates his own render/update, silences cfperch's squawk sequence, and flips cfprisonguard's alarm behavior */
    ...
    GAMEBIT_SC_TotemTreeHit1 = 0x7D,
    GAMEBIT_SC_TotemTreeHit2 = 0x7E,
    GAMEBIT_SC_TotemTreeHit3 = 0x7F,
    GAMEBIT_SC_TotemTreeSequenceComplete = 0x80,
    GAMEBIT_SC_TotemPoleFrontLit = 0x81,
    GAMEBIT_SC_TotemPoleLeftLit = 0x82,
    GAMEBIT_SC_TotemPoleRightLit = 0x83,
    GAMEBIT_SC_TotemPoleRearLit = 0x84,
    ...
    GAMEBIT_SH_QueenFed = 0x9E,
    GAMEBIT_NpcTalkRelated009F = 0x9F, /* table 0; related to talking to NPCs */
    GAMEBIT_GalleonRelated00A0 = 0xA0, /* table 1 */
    GAMEBIT_CC_GasVentPuzzleComplete = 0xA3,
    GAMEBIT_WM_GalleonRelated00A4 = 0xA4, /* table 1 */
    GAMEBIT_WM_SwitchRelatedA7 =
        0xA7, /* table 0; related to KP pressure switch door; toggled repeatedly during Krystal getting captured scene */
    GAMEBIT_ITEM_FireGem_Count = 0xA9, /* table 2; size 2 */
    GAMEBIT_CC_FireGemSourceActivated = 0xAA,
    ...
    GAMEBIT_SH_ReturnedToQueen =
        0xBF,                      /* table 2; hint 270; Talked to queen after bringing Tricky back from Ice Mountain */
    ...
    GAMEBIT_IM_OnBike =
        0xC8, /* table 1; set when you can actually steer but also during the cutscene of "rescuing" Tricky */
    ...
    GAMEBIT_CC_FireGemGateAActivated = 0xF1,
    GAMEBIT_SH_KilledBloop16 = 0xF5, /* table 1 */
    GAMEBIT_ITEM_SpiritTestFear_Got =
        0xFF, /* table 2; hint 355; have the Krazoa Spirit from Test of Fear (and haven't released it) */
    GAMEBIT_CC_FireGemGateBActivated = 0xFE,
    ...
    GAMEBIT_SawTrickyFood = 0x119,
    GAMEBIT_ITEM_FireSpellStone1_Got = 0x123, /* table 2; hint 297; ref temple/VFP_PodiumP key */
    GAMEBIT_WM_EnteredKrazoaTest1_0129 =
        0x129, /* table 0; set when entering Krazoa test 1, cleared when talking to spirit */
    GAMEBIT_ITEM_TrickyFood_GrabInProgress =
        0x12E, /* Global latch: set by dll_01A7 EdibleMushroom when a GrubTub Fungus offers itself to the player (grab in range), cleared once the grab-complete reply lands and TrickyFood_Count (or the romDefNo-0x658 variant's bit) increments; read by Tricky's food check as a stand-in for already owning TrickyFood */
    GAMEBIT_MMSH_SpiritGrantTriggered = 0x12A,
    GAMEBIT_ShrineRelated012B = 0x12B,
    GAMEBIT_MMSH_ShrineRelated012D = 0x12D,
    ...
    GAMEBIT_WM_Spirit1Related_0143 =
        0x143,                    /* table 0; set when collecting first spirit; cleared when it enters krazoa head */
    GAMEBIT_MC_ActNo = 0x144,     /* table 1; size 4; Magic Cave */
    GAMEBIT_MC_ObjGroups = 0x145, /* table 3; size 32 */
    GAMEBIT_GPSH_ActivateSymbolSpawns = 0x148,
    ...
    GAMEBIT_DBSH_SpiritGrantTriggered = 0x15F,
    GAMEBIT_CC_CameraActionBlocked = 0x160,
    GAMEBIT_CC_ObjGroup1EEnabled = 0x161,
    ...
    GAMEBIT_DBSH_SymbolRiseComplete = 0x16A,
    GAMEBIT_DBSH_SymbolSpinSucceeded = 0x16B,
    GAMEBIT_DBSH_SymbolSpinFailed = 0x16C,
    ...
    GAMEBIT_CC_GasVentActive = 0x1C0,
    GAMEBIT_CC_QueenApproached = 0x1C2,
    ...
    GAMEBIT_WM_KrazTest1TorchesActive =
        0x1D3, /* Krazoa Test 1 shrine-countdown active; set by dll_019B when the timer starts with no unlocks yet, read by dll_019C torch props to ignite; cleared on test failure */
    GAMEBIT_DLL410_TriggerBase = 0x1CD,
    GAMEBIT_DLL410_DroppedItem = 0x1CE,
    GAMEBIT_WM_KrazTest1Passed = 0x1D1,
    GAMEBIT_WM_KrazTest1ResetTorches = 0x1D4,
    GAMEBIT_WM_KrazTest1Related01D5 = 0x1D5,
    ...
    GAMEBIT_IM_TrickyRelated01ED =
        0x1ED, /* table 3; set when warping to Ice Mountain, cleared when starting Tricky landing scene */
    GAMEBIT_SHARPCLAW_STATE_01E7 = 0x1E7,
    ...
    GAMEBIT_CC_CameraActionReady = 0x22A,
    GAMEBIT_ITEM_FireSpellStone1_Used = 0x22B, /* table 2 */
    GAMEBIT_CC_CameraActionStop = 0x22D,
    GAMEBIT_CC_CameraActionGate = 0x22E,
    ...
    GAMEBIT_SH_OpenPortalRequested = 0x23B,
    ...
    GAMEBIT_ENV_dayNo =
        0x2BA, /* table 3; size 8; Counts from 0 to 27, increasing every morning in-game time. Used for environmental effects. */
    GAMEBIT_SC_TotemBondComplete = 0x2BC,
    ...
    GAMEBIT_IM_BikeRelated0379 =
        0x379, /* table 2; set to 0x19 when finishing race even though max is 1 - in kiosk, related to demo mode - map 0x19 is newicemount3 */
    ...
    GAMEBIT_WM_FinaleQuakeActive =
        0x38D, /* Krazoa Palace finale: set by WM_Crystal (dll_020E) once fully risen after the 6th spirit is returned, gating the WM_sun bank-0 quake/envfx countdown until it clears and 0x38F fires */
    GAMEBIT_KrazTest1Related0390 =
        0x390, /* table 3; set when entering Krazoa test 1, cleared when talking to WarpStone */
    GAMEBIT_TELEPORT_MUSIC_LOCK = 0x393,
    GAMEBIT_DBAY_ObjGroups = 0x397, /* table 3; size 32 */
    GAMEBIT_NW_GeyserComplete = 0x398,
    ...
    GAMEBIT_CC_ObjGroup1FDisabled = 0x3D6,
    GAMEBIT_CC_ObjGroup1DEnabled = 0x3D7,
    GAMEBIT_ITEM_DinoHorn_3D8 = 0x3D8, /* table 0 */
    GAMEBIT_SB_ObjGroups = 0x3E0,      /* table 3; size 32; frontend, galleonship, Ship Battle */
    GAMEBIT_DIM_TriggerLostInBlizzard =
        0x3E2,                          /* table 0; Trigger scene where Fox walks off into blizzard and comes back */
    ...
    GAMEBIT_ITEM_NWFood_Got =
        0x3E9, /* table 0; Alpine Root while riding SnowHorn through blizzard; collecting one sets this to 1, then 0 */
    GAMEBIT_CC_GasVentIntroTriggered = 0x3EC,
    ...
    GAMEBIT_DBSH_ActNo = 0x472,
    GAMEBIT_DBSH_ObjGroups = 0x473, /* table 3; size 32 */
    GAMEBIT_DBSH_Related0474 = 0x474,
    ...
    GAMEBIT_NW_MammothTumbleweedCount =
        0x48B, /* SnowHorn Wastes mammoth's tumbleweed-bush capture count (0-3, persists across reload); reaching 3 completes the air-meter rescue sequence for the SnowHorn Gate Keeper, and Tricky polls it to sync its tumbleweed-chase substate */
    ...
    GAMEBIT_DR_KTrexPathA =
        0x55A, /* Dragon Rock K-Trex (Galdon) arena - path A active; toggles with 0x55b when a floor plate is charged to max, selecting which branch-path bits ktrexlevel applies */
    GAMEBIT_DR_KTrexPathB =
        0x55B, /* Alternate branch-path selector for the Galdon T-rex arena (Dragon Rock); mutually exclusive with 0x55a, set when a floor switch's charge cycle maxes out and polled by ktrexlevel_updatePathGameBits to choose the arena's second path-bit layout */
    GAMEBIT_GPSH_ResetSymbolCreators = 0x5AF,
    GAMEBIT_WC_Unk0564 = 0x564, /* table 2 */
    GAMEBIT_DR_KTrexPhaseCounter =
        0x572, /* Dragon Rock K.Rex (Galdon) boss-arena phase/stage counter, advanced by the fight's state machine and read by DR floor switches (shifted right 1) to pick their rise curve */
    ...
    GAMEBIT_OFP_PuzzlePadShowSolution =
        0x5E4, /* Ocean Force Point electric-floor solution display is active while the puzzle pad is pressed */
    ...
    GAMEBIT_CC_GasVentPuzzleState = 0x620,
    ...
    GAMEBIT_SH_Landed064B =
        0x64B, /* table 0; set when Fox first steps foot on the planet; cleared after Pepper scene */
    GAMEBIT_SC_TotemBondOrbCollected = 0x64C,
    GAMEBIT_SC_TotemBondRing0Active = 0x64D,
    GAMEBIT_SC_TotemBondRing1Active = 0x64E,
    GAMEBIT_SC_TotemBondRing2Active = 0x64F,
    GAMEBIT_SC_TotemBondRing3Active = 0x650,
    ...
    GAMEBIT_SC_LightfootChallengeDifficulty0 = 0x768,
    GAMEBIT_SC_LightfootChallengeDifficulty1 = 0x769,
    GAMEBIT_SC_LightfootChallengeDifficulty2 = 0x76A,
    GAMEBIT_SC_LightfootChallengeDifficulty3 = 0x76B,
    ...
    GAMEBIT_LV_TestStrengthWon = 0x784,
    GAMEBIT_LV_TestStrengthLost = 0x786,
    GAMEBIT_OFP_LoadBlockSlidePuzzle2 =
        0x7A1, /* loads Ocean Force Point object group 6, the lower block-slide puzzle */
    GAMEBIT_DR_ActiveCloud = 0x7A9,
    ...
    GAMEBIT_ITEM_WMGoldKey_Got =
        0x91C, /* table 1; opens door to barrel at start as Krystal; collecting this also enables C menu */
    ...
    GAMEBIT_CFPowerBaseRelated0973 =
        0x973,                     /* cleared when a power gem is installed in a CloudRunner Fortress power base */
    ...
    GAMEBIT_SH_WarpStoneLookAtPlayer = 0xA45,
    GAMEBIT_SB_DoorOpen = 0xA4B, /* table 0; ref frontend/HitAnimator target */
    GAMEBIT_SC_TotemBondRing4Active = 0xA4C,
    GAMEBIT_SC_TotemBondRing5Active = 0xA4D,
    GAMEBIT_SC_TotemBondRing6Active = 0xA4E,
    GAMEBIT_SC_TotemBondRing7Active = 0xA4F,
    GAMEBIT_SC_LightfootChallengeDifficulty4 = 0xA50,
    GAMEBIT_SC_LightfootChallengeDifficulty5 = 0xA51,
    GAMEBIT_SC_LightfootChallengeDifficulty6 = 0xA52,
    GAMEBIT_SC_LightfootChallengeDifficulty7 = 0xA53,
    ...
    GAMEBIT_WarpStoneUnlockedCC =
        0xABA, /* table 1; Unused feature where WarpStone would send you to more places. Setting these bits enables an invisble destination menu, b */
    ...
    GAMEBIT_MMSH_ShrineRelated0AE4 = 0xAE4,
    GAMEBIT_MMSH_ShrineRelated0AE5 = 0xAE5,
    GAMEBIT_MMSH_TestMusicActive = 0xAE6,
    GAMEBIT_ITEM_CCGoldBar_Count = 0xAF7, /* table 2; size 3 */
    GAMEBIT_CC_MusicC0 = 0xB24,
    ...
    GAMEBIT_WC_PushBlockTimerActive =
        0xBA6, /* Set while either Walled City push-block timed puzzle (A or B) is actively counting down/up; cleared on completion, timeout, or reset; gates the ambient-music latch in wclevelcont_syncProgressBits */
    ...
    GAMEBIT_SC_TotemPuzzleActivated = 0xC10,
    ...
    GAMEBIT_LV_ChallengeGate1Target0 = 0xC38,
    GAMEBIT_LV_ChallengeGate1Target1 = 0xC39,
    GAMEBIT_LV_ChallengeGate1Target2 = 0xC3A,
    GAMEBIT_LV_ChallengeGate2Target0 = 0xC3B,
    GAMEBIT_LV_ChallengeGate2Target1 = 0xC3C,
    GAMEBIT_LV_ChallengeGate2Target2 = 0xC3D,
    GAMEBIT_SC_ChallengeGate3Target0 = 0xC3E,
    GAMEBIT_SC_ChallengeGate3Target1 = 0xC3F,
    GAMEBIT_SC_ChallengeGate3Target2 = 0xC40,
    GAMEBIT_SC_MusicTreeTarget1Hit = 0xC41,
    GAMEBIT_LV_ChallengeGate2Active = 0xC42,
    GAMEBIT_SC_MusicTreeTarget2Hit = 0xC43,
    GAMEBIT_SC_MusicTreeActive = 0xC44,
    GAMEBIT_SC_MusicTreeTarget3Hit = 0xC45,
    GAMEBIT_SC_ChallengeGate3Active = 0xC46,
    GAMEBIT_CC_DayNightMusic = 0xC47,
    GAMEBIT_SH_QueenPortalComplete = 0xC48,
    GAMEBIT_LV_ChallengeGate1TargetHitRecorded = 0xC49,
    GAMEBIT_LV_ChallengeGate2TargetHitRecorded = 0xC4A,
    GAMEBIT_SC_ChallengeGate3TargetHitRecorded = 0xC4B,
    GAMEBIT_LV_ChallengeGate1Complete = 0xC52, /* challenge-gate NPC 1 reward latch (ident 0x46A51) */
    GAMEBIT_LV_ChallengeGate2Complete =
        0xC53, /* One-shot reward latch for LightFoot Village challenge-gate NPC 2 (ident 0x46A55): fires once bits 0xc3b/0xc3c/0xc3d (the three baby-lightfoot-delivered flags) are all set, permanently disabling that NPC's interaction and unlocking swapcircle map objgroup 0xa */
    GAMEBIT_SC_ChallengeGate3Complete =
        0xC54, /* One-shot latch: Lightfoot Village's third target-hit challenge gate (encounterType 0x49928) has been completed and its reward sequence (7) already played */
    ...
    GAMEBIT_DBSH_ShrineRelated0C72 = 0xC72,
    GAMEBIT_DBSH_ShrineRelated0C73 = 0xC73,
    ...
    GAMEBIT_SHRINE_MUSIC_LOCK =
        0xCBB, /* Krazoa-shrine music lock: set (success-gated in GPSH) when a Krazoa shrine object (MMSH/ECSH/DFSH/DBSH/GPSH) frees; every area's level-control DLL watches it via GameBitLatch_Update to start/stop MUSICTRIG_PU3_Adventure_c4 and hand back its own ambient music, and it also raises audio.c's SFX reverb bus and suppresses doorf4's door-close SFX during the transition */
    ...
    GAMEBIT_NW_Tricky_HerdingComplete = 0xD11,
    ...
    GAMEBIT_SawStaffBoostPad =
        0xD2A, /* table 2; StaffActivated checks for this (hardcoded) in some case relating to sequences */
    ...
    GAMEBIT_GPSH_TestKnowledgeRunning =
        0xDD2, /* GPSH shrine (Test Of Knowledge) trial-active latch - set on activation, cleared on solve/timeout/reset; gates MUSICTRIG_krazoa_tunnel_2 via GameBitLatch_Update, mirroring GAMEBIT_ECSH_TestObservRunning */
    GAMEBIT_DBSH_TestStrengthRunning = 0xDD3,
    ...
    GAMEBIT_CreditsRelated0DF6 =
        0xDF6, /* table 0; Set on title screen when showing credits (maybe "should run credits"?) */
    ...
    GAMEBIT_OFP_ElectricFloorPuzzleAct1Complete =
        0xE57, /* disables the act 1 electric-floor puzzle and lowers its floor bars */
    GAMEBIT_OFP_ElectricFloorPuzzleAct2Complete =
        0xE58,                               /* disables the act 2 electric-floor puzzle and lowers its floor bars */
    ...
    GAMEBIT_MMSH_FearTestRelated0E82 = 0xE82,
    GAMEBIT_MMSH_FearTestRelated0E83 = 0xE83,
    GAMEBIT_MMSH_FearTestRelated0E84 = 0xE84,
    GAMEBIT_MMSH_FearTestRelated0E85 = 0xE85,
    ...
    GAMEBIT_NW_RescueSequenceActive = 0xECD,
    ...
    GAMEBIT_LV_TestStrengthSequenceActive = 0xF1D,
    GAMEBIT_SB_CanShootPropeller = 0xF1E, /* table 0 */
    GAMEBIT_NW_MammothBush1 = 0xF22,
    GAMEBIT_NW_MammothBush2 = 0xF23,
    GAMEBIT_NW_MammothBush3 = 0xF24,
    GAMEBIT_NW_MammothBush4 = 0xF25,
    GAMEBIT_CC_GoldBarCompletionSfxPlayed = 0xF26,
    GAMEBIT_TIMER_MUSIC_LOCK = 0xF31,
    ...
    GAMEBIT_SH_ToldGetViewFinder =
        0xF3E, /* table 2; Set when arriving after getting 4th stone; triggers a communication if you don't have viewfinder */
