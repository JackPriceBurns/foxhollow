...
#define OBJECT_INIT_ADAPTER(adapter, callback, ...)                                                                    \
    static void adapter(GameObject* obj, void* placement, int flags) {                                                 \
        callback(__VA_ARGS__);                                                                                         \
    }
...
#define OBJECT_RENDER_ADAPTER(adapter, callback, ...)                                                                  \
    static void adapter(GameObject* obj, int arg2, int arg3, int arg4, int arg5, s8 visible) {                         \
        callback(__VA_ARGS__);                                                                                         \
    }
#define OBJECT_FREE_ADAPTER(adapter, callback, ...)                                                                    \
    static void adapter(GameObject* obj, int flags) {                                                                  \
        callback(__VA_ARGS__);                                                                                         \
    }
...
#define EMPTY_OBJECT_DESCRIPTOR(reserved0Value)                                                                        \
    {                                                                                                                  \
        .header = {.metadata = {(reserved0Value)} }                                                                    \
    }
