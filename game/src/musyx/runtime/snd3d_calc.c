...
void CalcEmitter(SND_EMITTER* emitter, f32* vol, f32* doppler, f32* xPan,
                           f32* yPan, f32* zPan)
{
...
void SetFXParameters(SND_EMITTER* emitter, f32 vol, f32 xPan, f32 yPan, f32 zPan,
                                    f32 pitch)
{
    u32 handle;
    u16 value14;
 ...
 */
int AddStartingEmitter(SND_EMITTER* emitter, f32 vol, f32 xPan, f32 yPan, f32 zPan,
                                  f32 pitch)
{
    START_GROUP* group;
    START_LIST* scan;
