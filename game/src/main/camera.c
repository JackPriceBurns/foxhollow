...
void Camera_ApplyFullViewport(void) {
    ...
    if (renderMode->field_rendering != 0) {
        GXSetViewportJitter(0.0f, 0.0f, renderMode->fbWidth, renderMode->xfbHeight, 0.0f, 1.0f, gViewportJitterField);
    } else {
...
void Camera_ApplyEffectDepthViewport(void) {
    ...
    if (renderMode->field_rendering != 0) {
        GXSetViewportJitter(0.0f, 0.0f, renderMode->fbWidth, renderMode->xfbHeight, (-0.075f), 1.0f,
                            gViewportJitterField);
    } else {
        GXSetViewport(0.0f, 0.0f, renderMode->fbWidth, renderMode->xfbHeight, (-0.075f), gCameraEffectViewportFarZ);
    }
}
...
void Camera_ApplyTransparentViewport(void) {
    ...
    if (renderMode->field_rendering != 0) {
        GXSetViewportJitter(0.0f, 0.0f, renderMode->fbWidth, renderMode->xfbHeight, (-0.01f), 1.0f,
                            gViewportJitterField);
    } else {
