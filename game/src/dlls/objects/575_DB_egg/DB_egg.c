...
void dbegg_setupFromDef(GameObject* obj, u8* state) {
    ...
    ((DbEggState*)state)->mode =
        (u8)(mainGetBit(ObjAnim_ReadPlacementS16(&obj->anim, &(config->triggerGameBit))) != 0 ? 3 : 1);
    ...
    ((DbEggState*)state)->mode =
        (u8)(mainGetBit(ObjAnim_ReadPlacementS16(&obj->anim, &(config->activateGameBit))) != 0 ? 5 : 12);
    ...
    if (objPosToMapBlockIdx((obj)->anim.localPosX, (obj)->anim.localPosY, (obj)->anim.localPosZ) != -1) {
        ...
        case DBEGG_MODE_DRIFTING:
            if (egg->flags119 & 4) {
                ...
                (obj)->anim.velocityY = (obj)->anim.velocityY + (data->base.posY - (obj)->anim.localPosY) / fz;
                (obj)->anim.velocityZ = (obj)->anim.velocityZ + (data->base.posZ - (obj)->anim.localPosZ) / fz;
            ...
            if (randomGetRange(0, 10) == 0) {
                ...
                if (nb != 0) {
                    (*gWaterfxInterface)
                        ->spawnRipple((obj)->anim.localPosX, (obj)->anim.localPosY - egg->waterOffset,
        ...
        case DBEGG_MODE_HOMING:
            ObjHits_DisableObject(obj);
            (obj)->anim.velocityX = (obj)->anim.velocityX + (data->base.posX - (obj)->anim.localPosX) / (fz = 2500.0f);
            (obj)->anim.velocityY = (obj)->anim.velocityY + (data->base.posY - (obj)->anim.localPosY) / fz;
            (obj)->anim.velocityZ = (obj)->anim.velocityZ + (data->base.posZ - (obj)->anim.localPosZ) / fz;
