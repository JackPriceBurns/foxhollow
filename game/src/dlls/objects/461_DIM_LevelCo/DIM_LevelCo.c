...
void dim_levelcontrol_update(GameObject* obj) {
    ...
    GameBitLatch_Update(&state->musicLatch, 1, DIM_LEVEL_CONTROL_LATCH_GAMEBIT_01A7, GAMEBIT_SH_Landed064B,
                        DIM_LEVEL_CONTROL_LATCH_GAMEBIT_0C1E, MUSICTRIG_drako_1);
    GameBitLatch_Update(&state->musicLatch, 2, GAMEBIT_SH_WarpStoneRelated01A8, GAMEBIT_SH_Entered00C0,
                        DIM_LEVEL_CONTROL_LATCH_GAMEBIT_0C1F, DIM_LEVEL_CONTROL_MUSICTRIG_0CF);
    GameBitLatch_Update(&state->musicLatch, 4, DIM_LEVEL_CONTROL_LATCH_GAMEBIT_01BA, GAMEBIT_IM_TrickyRelated01B9,
                        DIM_LEVEL_CONTROL_LATCH_GAMEBIT_0C20, state->dayNightMusicTrigger);
    GameBitLatch_Update(&state->musicLatch, 8, -1, -1, DIM_LEVEL_CONTROL_LATCH_GAMEBIT_0D8F,
                        DIM_LEVEL_CONTROL_MUSICTRIG_0DC);
    GameBitLatch_Update(&state->musicLatch, 0x10, DIM_LEVEL_CONTROL_LATCH_GAMEBIT_01A7, GAMEBIT_SH_Landed064B,
                        DIM_LEVEL_CONTROL_LATCH_GAMEBIT_0C1E, MUSICTRIG_citytombs_ed);
    GameBitLatch_Update(&state->musicLatch, 0x20, GAMEBIT_SH_WarpStoneRelated01A8, GAMEBIT_SH_Entered00C0,
                        DIM_LEVEL_CONTROL_LATCH_GAMEBIT_0C1F, MUSICTRIG_Teleport);
    GameBitLatch_Update(&state->musicLatch, 0x40, DIM_LEVEL_CONTROL_LATCH_GAMEBIT_01BA, GAMEBIT_IM_TrickyRelated01B9,
                        DIM_LEVEL_CONTROL_LATCH_GAMEBIT_0C20, DIM_LEVEL_CONTROL_MUSICTRIG_035);
    GameBitLatch_Update(&state->musicLatch, 0x100, -1, -1, GAMEBIT_DIM_TriggerLostInBlizzard,
                        DIM_LEVEL_CONTROL_MUSICTRIG_02B);
}
