...
void hoodedZyck_updateIdle(GameObject* obj, void* state) {
    ...
    if (!resetting) {
        ...
        groundHit = trackGetLineIntersect(fromPos, toPos, 0.0f, 3, (TrackBBoxHit*)hitOut, obj,
                                          (u32)((EnemyState*)state)->pathControl.primaryHitType, 0xffffffff, 0xff, 0);
        ...
        (obj)->anim.rotY = ((EnemyState*)state)->pathControl.tiltPitch;
        (obj)->anim.rotZ = ((EnemyState*)state)->pathControl.tiltRoll;
    }
    return;
}
    ...
    if (moved == 0) {
        ...
        *(s16*)obj = *(s16*)obj + ((EnemyState*)state)->phaseAngle;
        ...
        noHit = !(u8)trackGetLineIntersect(posA, tgtA, 0.0f, 3, &bufA, obj,
                                           ((EnemyState*)state)->pathControl.primaryHitType, -1, 0xff, 0);
        ang = getAngle(obj->anim.localPosX - ((GameObject*)((EnemyState*)state)->trackedObj)->anim.localPosX,
                ...
                if (t < 0x4000) {
                    *(s16*)obj = -*(s16*)obj;
                    ...
                    if ((u8)trackGetLineIntersect(posB, tgtB, 0.0f, 3, &bufB, obj,
                                                  ((EnemyState*)state)->pathControl.primaryHitType, -1, 0xff, 0) == 0) {
    ...
    if (moved == 0) {
        ...
        *(s16*)obj = (f32)((EnemyState*)state)->phaseAngle * timeDelta + (f32)(int)*(s16*)obj;
        ...
        if (grabbed != 0 && obj->anim.currentMove == 6) {
            ...
            if (grabbed != 0 || (mag < 1000 && obj->anim.currentMove != 2 && obj->anim.currentMove != 4 &&
