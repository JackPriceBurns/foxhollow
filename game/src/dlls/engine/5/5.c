        ...
        if (sunT < 0.1f) {
            ...
            if (sunT > 0.9f) {
                if (sunT > 1.0f) {
                    ...
                    *(s16*)&gSkySunAlpha = (2550.0f * (0.1f - (sunT - 0.9f)));
                }
            } else {
                gSkySunAlpha = 0xff;
            }
        ...
        if (moonTC < 0.1f) {
            ...
            if (moonTC > 0.9f) {
                if (moonTC > 1.0f) {
                    ...
                    *(s16*)&gSkyMoonAlpha = (2550.0f * (0.1f - (moonTC - 0.9f)));
                }
            } else {
                gSkyMoonAlpha = 0xff;
            }
    ...
    if (config != NULL && ((int)config->flags & 2) != 0) {
        ...
        for (i = 0, iofs = 0; i < 2; i++) {
            if ((mask & (1 << i)) != 0) {
                ...
                if (config->cloudBlendMode != 0) {
                    ((SkyLight*)(gSkyState + iofs + 0x20))->flags.cloud = (config->cloudBlendMode & 1) + 1;
                } else {
        ...
        if ((config->flags & 1) == 0) {
            ...
            if (((SkyState*)gSkyState)->fadeFlags.fadePending != 0) {
                ...
                if (fhReadBE16(&config->fadeDurationA) != 0) {
                    ((SkyState*)gSkyState)->fadeRate = 1.0f / (10.0f * (f32)fhReadBE16(&config->fadeDurationA));
                } else {
