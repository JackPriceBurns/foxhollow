...
EFFECT_RESOURCE_ADAPTERS(gEffect10Resource, Effect10_initialise, Effect10_spawnObject, Effect10_updateFrameState)

EffectResourceDescriptor Effect10_funcs = {
    {
        {0, 0, 0, OBJECT_DESCRIPTOR_FLAGS_6_SLOTS},
        gEffect10ResourceAcquire,
        Effect10_release,
    },
    {
        NULL,
        Effect10_func03_nop,
        gEffect10ResourceSpawn,
        gEffect10ResourceUpdate,
    },
};
