...
EFFECT_RESOURCE_ADAPTERS_NO_EXTRA(gEffect11Resource, Effect11_initialise, Effect11_spawnObject, Effect11_func05_nop)

EffectResourceDescriptor Effect11_funcs = {
    {
        {0, 0, 0, 0x00050000},
        gEffect11ResourceAcquire,
        Effect11_release,
    },
    {
        NULL,
        Effect11_func03_nop,
        gEffect11ResourceSpawn,
        gEffect11ResourceUpdate,
    },
};
