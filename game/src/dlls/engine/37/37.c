...
EFFECT_RESOURCE_ADAPTERS(gEffect12Resource, Effect12_initialise, Effect12_spawnObject, Effect12_func05_nop)

EffectResourceDescriptor Effect12_funcs = {
    {
        {0, 0, 0, 0x00050000},
        gEffect12ResourceAcquire,
        Effect12_release,
    },
    {
        NULL,
        Effect12_func03_nop,
        gEffect12ResourceSpawn,
        gEffect12ResourceUpdate,
    },
};
