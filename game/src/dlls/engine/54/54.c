...
void EnterSaveNameScreen_render(void) {
    ...
    gameTextSetColor((int)(mathSinf(0.17259522f * gEnterSaveNameColorAnimTime) * 128.0f + 127.0f),
                     ...
                     (int)(mathSinf(0.11506347f * gEnterSaveNameColorAnimTime) * 128.0f + 127.0f), 0xff);
...
u32 EnterSaveNameScreen_run(void) {
    ...
    gEnterSaveNameScrollWrapOffset =
        (gEnterSaveNameScrollPos < (f32)(gEnterSaveNameTotalWidth >> 2)) ? gEnterSaveNameTotalWidth : 0;
    if ((gEnterSaveNameScrollVelocity != 0.0f) || (gEnterSaveNameTargetScrollVel != 0.0f)) {
        if ((gEnterSaveNameScrollVelocity < 0.0f) || (gEnterSaveNameTargetScrollVel < 0.0f)) {
            if (gEnterSaveNameScrollVelocity > -1.2f) {
                ...
                gEnterSaveNameScrollVelocity = 0.025f * (gEnterSaveNameTargetScrollVel - gEnterSaveNameScrollVelocity) +
                                               gEnterSaveNameScrollVelocity;
            }
        } else if (gEnterSaveNameScrollVelocity < 1.2f) {
            gEnterSaveNameScrollVelocity = 1.2f;
        } else {
            gEnterSaveNameScrollVelocity =
                0.025f * (gEnterSaveNameTargetScrollVel - gEnterSaveNameScrollVelocity) + gEnterSaveNameScrollVelocity;
        }
    }
...
UI_RESOURCE_ADAPTERS(gEnterSaveNameScreenUiResource, EnterSaveNameScreen_initialise, EnterSaveNameScreen_run,
                     EnterSaveNameScreen_render)
