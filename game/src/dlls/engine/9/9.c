    ...
    if (cfg->mainCloudIndex != 0) {
        if (cfg->mainCloudIndex < 5) {
            if (gCloudActionRuntime.mainCloudAssetId != tbl->mainCloudAssetIds[cfg->mainCloudIndex]) {
                ...
                gCloudActionRuntime.mainCloudObj = (GameObject*)objSetupObject(
                    Obj_AllocObjectSetup(0x20, tbl->mainCloudAssetIds[cfg->mainCloudIndex]), 4, -1, -1, 0);
    ...
    if (cfg->upperCloudIndex != 0) {
        if (cfg->upperCloudIndex < 4) {
            if (gCloudActionRuntime.upperCloudAssetId != tbl->upperCloudAssetIds[cfg->upperCloudIndex]) {
                ...
                gCloudActionRuntime.upperCloudObj = (GameObject*)objSetupObject(
                    Obj_AllocObjectSetup(0x20, tbl->upperCloudAssetIds[cfg->upperCloudIndex]), 4, -1, -1, 0);
    ...
    if (cfg->lowerCloudIndex != 0) {
        if (cfg->lowerCloudIndex < 5) {
            if (gCloudActionRuntime.lowerCloudAssetId != tbl->lowerCloudAssetIds[cfg->lowerCloudIndex]) {
                ...
                gCloudActionRuntime.lowerCloudObj = (GameObject*)objSetupObject(
                    Obj_AllocObjectSetup(0x20, tbl->lowerCloudAssetIds[cfg->lowerCloudIndex]), 4, -1, -1, 0);
