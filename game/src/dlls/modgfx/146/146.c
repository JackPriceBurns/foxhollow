...
u16 gDll92EffectResourceData[sizeof(Dll92EffectResource) / sizeof(u16)] = {
    0xff1a, 0x0000, 0x0000, 0x0000, 0x000f, 0x0000, 0x0000, 0x0000, 0x007f, 0x000f, 0x00e6, 0x0000, 0x0000,
    0x00ff, 0x000f, 0xff1a, 0x0000, 0x03e8, 0x0000, 0x0000, 0x0000, 0x0000, 0x03e8, 0x007f, 0x0000, 0x00e6,
    0x0000, 0x03e8, 0x00ff, 0x0000, 0x0000, 0x0004, 0x0003, 0x0000, 0x0001, 0x0004, 0x0001, 0x0002, 0x0004,
    0x0002, 0x0005, 0x0004, 0x0000, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0000, 0x0002, 0x0003, 0x0004,
    0x0005, 0x0000, 0x0000, 0x0006, 0x0014, 0x001a, 0x0000, 0x0000, 0x0000, 0x0000,
};

RESOURCE_ACQUIRE_ADAPTER(gDll92ResourceDescriptorAcquire, dll_92_initialise)

Dll92ResourceDescriptor gDll92ResourceDescriptor = {
    {{0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll92ResourceDescriptorAcquire, dll_92_release},
    NULL,
    dll_92_spawnEffect,
    0x00000000,
};
