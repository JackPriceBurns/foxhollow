...
s16 dll_84_spawnEffect(GameObject* sourceObj, int variant, PartFxSpawnParams* spawnParams, u32 spawnFlags, int owner,
    ...
    u8* resourceData = (u8*)gDll84EffectResourceData;
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(Dll84EffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(Dll84EffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(Dll84EffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(Dll84EffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(Dll84EffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(Dll84EffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(Dll84EffectResourceView, sequenceParams[6])];
    ...
    return (*gModgfxInterface)
        ->spawnEffect(&packet.context, 0, 0x24, (u8*)gDll84EffectResourceData, 0x10,
...
RESOURCE_ACQUIRE_ADAPTER(gDll84ResourceDescriptorAcquire, dll_84_initialise)

Dll84ResourceDescriptor gDll84ResourceDescriptor = {
    { {0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll84ResourceDescriptorAcquire, dll_84_release },
    NULL,
    dll_84_spawnEffect,
    0x00000000,
};
