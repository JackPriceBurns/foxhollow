...
u16 gDll64EffectResourceData[sizeof(Dll64EffectResourceView) / sizeof(u16)] = {
    ...
    0x00d0, 0x0000, 0x0000, 0x0000, 0x03e8, 0x0100, 0x0000, 0x0000, 0x0bb8, 0x03e8, 0x0000, 0x0040, 0x0362, 0x0bb8,
    0x01f4, 0x002c, 0x0040, 0x0362, 0x0bb8, 0xfe0c, 0x0058, 0x0040, 0x0000, 0x0bb8, 0xfc18, 0x0080, 0x0040, 0xfc9e,
    0x0bb8, 0xfe0c, 0x00a8, 0x0040, 0xfc9e, 0x0bb8, 0x01f4, 0x00d0, 0x0040, 0x0000, 0x0bb8, 0x03e8, 0x0100, 0x0040,
    ...
    0x0006, 0x0000, 0x0007, 0x0008, 0x0009, 0x000a, 0x000b, 0x000c, 0x000d, 0x0000, 0x0000, 0x0104, 0x003c, 0x0001,
...
void dll_64_spawnEffect(GameObject* sourceObj, int variant, void* spawnParams, u32 spawnFlags) {
    ...
    u8* resourceData = (u8*)gDll64EffectResourceData;
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(Dll64EffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(Dll64EffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(Dll64EffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(Dll64EffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(Dll64EffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(Dll64EffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(Dll64EffectResourceView, sequenceParams[6])];
    ...
    (*gModgfxInterface)
        ->spawnEffect(&packet.context, 0, 0xe, (u8*)gDll64EffectResourceData, 0xc,
...
RESOURCE_ACQUIRE_ADAPTER(gDll64ResourceDescriptorAcquire, dll_64_initialise)

Dll64ResourceDescriptor gDll64ResourceDescriptor = {
    {{0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll64ResourceDescriptorAcquire, dll_64_release},
    NULL,
    dll_64_spawnEffect,
};
