...
void dll_A9_spawnEffect(GameObject* sourceObj, int variant, PartFxSpawnParams* spawnParams, u32 flags, int unused,
    ...
    u8* resourceData = (u8*)gDllA9EffectResourceData;
    f32 scaleX;
    GfxCmd* commands;
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(DllA9EffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(DllA9EffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(DllA9EffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(DllA9EffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(DllA9EffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(DllA9EffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(DllA9EffectResourceView, sequenceParams[6])];
    ...
    (*gModgfxInterface)
        ->spawnEffect(&packet.context, 0, 0xe, (u8*)gDllA9EffectResourceData, 0xc,
...
RESOURCE_ACQUIRE_ADAPTER(gDllA9ResourceDescriptorAcquire, dll_A9_initialise)

DllA9ResourceDescriptor gDllA9ResourceDescriptor = {
    { {0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDllA9ResourceDescriptorAcquire, dll_A9_release },
    NULL,
    dll_A9_spawnEffect,
};
