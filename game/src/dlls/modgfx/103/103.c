...
void dll_67_spawnEffect(GameObject* sourceObj, int variant, void* spawnParams, u32 spawnFlags) {
    ...
    u8* resourceData = (u8*)gDll67EffectResourceData;
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(Dll67EffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(Dll67EffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(Dll67EffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(Dll67EffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(Dll67EffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(Dll67EffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(Dll67EffectResourceView, sequenceParams[6])];
    ...
    (*gModgfxInterface)
        ->spawnEffect(&packet.context, 0, 0x15, (u8*)gDll67EffectResourceData, 0x18,
...
RESOURCE_ACQUIRE_ADAPTER(gDll67ResourceDescriptorAcquire, dll_67_initialise)

Dll67ResourceDescriptor gDll67ResourceDescriptor = {
    { {0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll67ResourceDescriptorAcquire, dll_67_release },
    NULL,
    dll_67_spawnEffect,
    0,
};
