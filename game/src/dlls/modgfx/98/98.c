...
u16 gDll62EffectResourceData[sizeof(Dll62EffectResourceView) / sizeof(u16)] = {
    0x0000, 0x0000, 0x03e8, 0x0000, 0x0000, 0x0362, 0x0000, 0x01f4, 0x002c, 0x0000, 0x0362, 0x0000, 0xfe0c, 0x0058,
    0x0000, 0x0000, 0x0000, 0xfc18, 0x0080, 0x0000, 0xfc9e, 0x0000, 0xfe0c, 0x00a8, 0x0000, 0xfc9e, 0x0000, 0x01f4,
    0x00d0, 0x0000, 0x0000, 0x0000, 0x03e8, 0x0100, 0x0000, 0x0000, 0x0640, 0x03e8, 0x0000, 0x0020, 0x0362, 0x0640,
    0x01f4, 0x002c, 0x0020, 0x0362, 0x0640, 0xfe0c, 0x0058, 0x0020, 0x0000, 0x0640, 0xfc18, 0x0080, 0x0020, 0xfc9e,
    0x0640, 0xfe0c, 0x00a8, 0x0020, 0xfc9e, 0x0640, 0x01f4, 0x00d0, 0x0020, 0x0000, 0x0640, 0x03e8, 0x0100, 0x0020,
    0x0000, 0x1770, 0x03e8, 0x0000, 0x0040, 0x0362, 0x1770, 0x01f4, 0x002c, 0x0040, 0x0362, 0x1770, 0xfe0c, 0x0058,
    0x0040, 0x0000, 0x1770, 0xfc18, 0x0080, 0x0040, 0xfc9e, 0x1770, 0xfe0c, 0x00a8, 0x0040, 0xfc9e, 0x1770, 0x01f4,
    0x00d0, 0x0040, 0x0000, 0x1770, 0x03e8, 0x0100, 0x0040, 0x0000, 0x0000, 0x0001, 0x0008, 0x0000, 0x0008, 0x0007,
...
void dll_62_spawnEffect(GameObject* sourceObj, int variant, PartFxSpawnParams* spawnParams, u32 spawnFlags) {
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(Dll62EffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(Dll62EffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(Dll62EffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(Dll62EffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(Dll62EffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(Dll62EffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(Dll62EffectResourceView, sequenceParams[6])];
    ...
    (*gModgfxInterface)
        ->spawnEffect(&packet.context, 0, 0x15, (u8*)gDll62EffectResourceData, 0x18,
...
RESOURCE_ACQUIRE_ADAPTER(gDll62ResourceDescriptorAcquire, dll_62_initialise)

Dll62ResourceDescriptor gDll62ResourceDescriptor = {
    {{0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll62ResourceDescriptorAcquire, dll_62_release},
    NULL,
    dll_62_spawnEffect,
    0,
};
