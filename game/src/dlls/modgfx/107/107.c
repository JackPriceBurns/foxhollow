...
void dll_6B_spawnEffect(GameObject* sourceObj, int variant, PartFxSpawnParams* spawnParams, u32 spawnFlags) {
    ...
    u8* resourceData = (u8*)gDll6BEffectResourceData;
    GameObject* context;
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(Dll6BEffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(Dll6BEffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(Dll6BEffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(Dll6BEffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(Dll6BEffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(Dll6BEffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(Dll6BEffectResourceView, sequenceParams[6])];
    ...
    (*gModgfxInterface)
        ->spawnEffect(&packet.context, 0, 5, (u8*)gDll6BEffectResourceData, 4,
...
RESOURCE_ACQUIRE_ADAPTER(gDll6BResourceDescriptorAcquire, dll_6B_initialise)

Dll6BResourceDescriptor gDll6BResourceDescriptor = {
    { {0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll6BResourceDescriptorAcquire, dll_6B_release },
    NULL,
    dll_6B_spawnEffect,
};
