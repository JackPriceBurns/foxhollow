...
u32 gDll66EffectResourceData[sizeof(Dll66EffectResourceView) / sizeof(u32)] = {
    ...
    0x003ffc9e, 0x0bb8fe0c, 0x0016003f, 0xfc9e0bb8, 0x01f4000b, 0x003f0000, 0x0bb803e8, 0x0000003f, 0x00001770,
...
void dll_66_spawnEffect(GameObject* sourceObj, int variant, void* spawnParams, u32 spawnFlags) {
    ...
    (*gModgfxInterface)
        ->spawnEffect(&packet, 0, 0x15, (u8*)gDll66EffectResourceData, 0x18,
