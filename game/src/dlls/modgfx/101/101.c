...
u16 gDll65EffectResourceData[sizeof(Dll65EffectResourceView) / sizeof(u16)] = {
    0x0000, 0x0000, 0x03e8, 0x0000, 0x0000, 0x0362, 0x00c8, 0x01f4, 0x0000, 0x000a, 0x0362, 0x0028, 0xfe0c, 0x0000,
    0x0015, 0x0000, 0x0096, 0xfc18, 0x0000, 0x001f, 0xfc9e, 0x005a, 0xfe0c, 0x0000, 0x002a, 0xfc9e, 0x000a, 0x01f4,
    0x0000, 0x0034, 0x0000, 0x0096, 0x03e8, 0x0000, 0x003f, 0x0000, 0x1900, 0x03e8, 0x003f, 0x0000, 0x0362, 0x189c,
    0x01f4, 0x003f, 0x000a, 0x0362, 0x1838, 0xfe0c, 0x003f, 0x0015, 0x0000, 0x1932, 0xfc18, 0x003f, 0x001f, 0xfc9e,
    0x1900, 0xfe0c, 0x003f, 0x002a, 0xfc9e, 0x18ec, 0x01f4, 0x003f, 0x0034, 0x0000, 0x1928, 0x03e8, 0x003f, 0x003f,
...
void dll_65_spawnEffect(GameObject* sourceObj, int variant, void* spawnParams, u32 spawnFlags) {
    ...
    u8* resourceData = (u8*)gDll65EffectResourceData;
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(Dll65EffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(Dll65EffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(Dll65EffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(Dll65EffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(Dll65EffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(Dll65EffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(Dll65EffectResourceView, sequenceParams[6])];
    ...
    (*gModgfxInterface)
        ->spawnEffect(&packet.context, 0, 0xe, (u8*)gDll65EffectResourceData, 0xc,
...
RESOURCE_ACQUIRE_ADAPTER(gDll65ResourceDescriptorAcquire, dll_65_initialise)

Dll65ResourceDescriptor gDll65ResourceDescriptor = {
    {{0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll65ResourceDescriptorAcquire, dll_65_release},
    NULL,
    dll_65_spawnEffect,
};
