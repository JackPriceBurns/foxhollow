...
u16 gDll74EffectResourceData[sizeof(Dll74EffectResourceView) / sizeof(u16)] = {
    ...
    0x0000, 0x0000, 0x0000, 0xfc18, 0x0020, 0x0000, 0xfc9e, 0x0000, 0xfe0c, 0x0016, 0x0000, 0xfc9e, 0x0000, 0x01f4,
    0x000b, 0x0000, 0x0000, 0x0000, 0x03e8, 0x0000, 0x0000, 0x0000, 0x157c, 0x03e8, 0x0000, 0x003b, 0x0362, 0x157c,
    0x01f4, 0x000b, 0x003b, 0x0362, 0x157c, 0xfe0c, 0x0016, 0x003b, 0x0000, 0x157c, 0xfc18, 0x0020, 0x003b, 0xfc9e,
    0x157c, 0xfe0c, 0x0016, 0x003b, 0xfc9e, 0x157c, 0x01f4, 0x000b, 0x003b, 0x0000, 0x157c, 0x03e8, 0x0000, 0x003b,
    0x0000, 0x1770, 0x03e8, 0x0000, 0x003f, 0x0362, 0x1770, 0x01f4, 0x000b, 0x003f, 0x0362, 0x1770, 0xfe0c, 0x0016,
    0x003f, 0x0000, 0x1770, 0xfc18, 0x0020, 0x003f, 0xfc9e, 0x1770, 0xfe0c, 0x0016, 0x003f, 0xfc9e, 0x1770, 0x01f4,
    0x000b, 0x003f, 0x0000, 0x1770, 0x03e8, 0x0000, 0x003f, 0x0000, 0x0000, 0x0001, 0x0008, 0x0000, 0x0008, 0x0007,
    ...
    0x0000, 0x000a, 0x00b4, 0x0028, 0x0000, 0x0000, 0x0000, 0x0000,
};
...
void dll_74_spawnEffect(GameObject* sourceObj, int variant, PartFxSpawnParams* spawnParams, u32 spawnFlags) {
    ...
    u8* resourceData = (u8*)gDll74EffectResourceData;
    ...
    packet.context.sequenceParams[0] = *(s16*)&resourceData[offsetof(Dll74EffectResourceView, sequenceParams[0])];
    packet.context.sequenceParams[1] = *(s16*)&resourceData[offsetof(Dll74EffectResourceView, sequenceParams[1])];
    packet.context.sequenceParams[2] = *(s16*)&resourceData[offsetof(Dll74EffectResourceView, sequenceParams[2])];
    packet.context.sequenceParams[3] = *(s16*)&resourceData[offsetof(Dll74EffectResourceView, sequenceParams[3])];
    packet.context.sequenceParams[4] = *(s16*)&resourceData[offsetof(Dll74EffectResourceView, sequenceParams[4])];
    packet.context.sequenceParams[5] = *(s16*)&resourceData[offsetof(Dll74EffectResourceView, sequenceParams[5])];
    packet.context.sequenceParams[6] = *(s16*)&resourceData[offsetof(Dll74EffectResourceView, sequenceParams[6])];
    ...
    if (variant == 0) {
        (*gModgfxInterface)
            ->spawnEffect(&packet.context, 0, 0x15, (u8*)gDll74EffectResourceData, 0x18,
...
RESOURCE_ACQUIRE_ADAPTER(gDll74ResourceDescriptorAcquire, dll_74_initialise)

Dll74ResourceDescriptor gDll74ResourceDescriptor = {
    {{0x00000000, 0x00000000, 0x00000000, 0x00030000}, gDll74ResourceDescriptorAcquire, dll_74_release},
    NULL,
    dll_74_spawnEffect,
    0,
};
